package com.fancyinnovations.fancyholograms.tests;

import com.fancyinnovations.fancyholograms.tests.api.HologramBuilderTest;
import com.fancyinnovations.fancyholograms.tests.api.HologramControllerTest;
import com.fancyinnovations.fancyholograms.tests.api.HologramRegistryTest;
...
public class FHTests {
    ...
    public FHTests() {
        ...
        addTest(HologramControllerTest.class);
